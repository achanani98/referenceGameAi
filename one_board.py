...
def main():
	...
	temp_user = copy.deepcopy(user_board)
	temp_comp = copy.deepcopy(comp_board)
	...
	for j in range(10000):
		...
		user_board = copy.deepcopy(temp_user)
		comp_board = copy.deepcopy(temp_comp)
		#print temp_comp
		#print temp_user

		if (j+1)%1000==0 : print str((j+1)/100) + '% complete'
		#game main loop
		while(1):
			...
			if comp_board == "WIN":
				#print "User WON! :)"
				#print hits_user,hits_comp,hits_comp - hits_user
				break
			#print 'b'
		...
		#print reward
		reward.append(hits_comp-hits_user)
		global hits_user,hits_comp
		hits_user=0
		hits_comp=0
